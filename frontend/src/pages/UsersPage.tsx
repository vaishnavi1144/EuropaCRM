      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          ...
          <form key={editing?.id ?? `new-${dialogOpen}`} onSubmit={saveUser} autoComplete="off" className="mt-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Field label="Full Name *"><input required name="europa-new-full-name" autoComplete="off" className="crm-input" value={name} onChange={(event) => handleTitleCaseChange(event, setName)} /></Field>
