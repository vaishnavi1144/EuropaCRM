...
import { handleTitleCaseChange } from '@/lib/titleCase';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <form onSubmit={submit} className="mt-5 space-y-4">
          ...
          <label className="block"><span className="mb-1.5 block text-xs font-semibold text-slate-700">Subject *</span><input required className="crm-input" value={subject} onChange={(event) => handleTitleCaseChange(event, setSubject)} /></label>
