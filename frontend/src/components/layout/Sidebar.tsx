import {
  ...
  Plus, UploadCloud, MessageSquare,
} from 'lucide-react';
...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      moduleItem({ label: 'Outcome & Feedback', path: '/outcome-feedback', icon: MessageSquare, permission: 'submissions' }, 'Add Record', undefined, 'Record List'),
    ...
    <>
      ...
      <aside className={cn(
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
          ...
          {/* Settings Section */}
          {(hasPermission('settings') || hasPermission('users')) && (
